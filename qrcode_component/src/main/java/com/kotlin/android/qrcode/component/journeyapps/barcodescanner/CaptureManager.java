...
public class CaptureManager {
    ...
    private IQRDecodeListener listener;

    private BarcodeCallback callback = new BarcodeCallback() {
        @Override
        public void barcodeResult(final BarcodeResult result) {
//            barcodeView.pause();//扫描结束后画面不让结束
    ...
    public void setQrResultListener(IQRDecodeListener listener) {
    ...
    public interface IQRDecodeListener {
        void onResult(BarcodeResult rawResult);
    }
}
