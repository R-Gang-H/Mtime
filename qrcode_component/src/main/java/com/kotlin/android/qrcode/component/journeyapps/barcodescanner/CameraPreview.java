...
import com.kotlin.android.qrcode.component.journeyapps.barcodescanner.camera.CameraInstance;
import com.kotlin.android.qrcode.component.journeyapps.barcodescanner.camera.CameraParametersCallback;
import com.kotlin.android.qrcode.component.journeyapps.barcodescanner.camera.CameraSettings;
import com.kotlin.android.qrcode.component.journeyapps.barcodescanner.camera.CameraSurface;
import com.kotlin.android.qrcode.component.journeyapps.barcodescanner.camera.CenterCropStrategy;
import com.kotlin.android.qrcode.component.journeyapps.barcodescanner.camera.DisplayConfiguration;
import com.kotlin.android.qrcode.component.journeyapps.barcodescanner.camera.FitCenterStrategy;
import com.kotlin.android.qrcode.component.journeyapps.barcodescanner.camera.FitXYStrategy;
import com.kotlin.android.qrcode.component.journeyapps.barcodescanner.camera.PreviewScalingStrategy;
...
//                frameInPreview.bottom * previewHeight / surfaceRect.height());
        previewFramingRect = new Rect(0, 0, width, height / 2);
    ...
    public Rect getFramingRect() {
        ...
        int topOffset = (display.getHeight() - height) / 5;
    ...
    protected Rect calculateFramingRect(Rect container, Rect surface) {
        ...
        Rect intersection = new Rect(container);//屏幕宽高
