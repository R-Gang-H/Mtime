...
package com.kotlin.android.community.ui.person.center.view;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private final Runnable calRunnable = new Runnable() {
        @Override
        public void run() {
...
//        mButton.setVisibility(View.VISIBLE);
    ...
    private void init(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.MovieDetailsExpandableTextView);
        mMaxCollapsedLines = typedArray.getInt(R.styleable.MovieDetailsExpandableTextView_maxCollapsedLines, MAX_COLLAPSED_LINES);
        mAnimationDuration = typedArray.getInt(R.styleable.MovieDetailsExpandableTextView_animDuration, DEFAULT_ANIM_DURATION);
        mAnimAlphaStart = typedArray.getFloat(R.styleable.MovieDetailsExpandableTextView_animAlphaStart, DEFAULT_ANIM_ALPHA_START);
        mExpandDrawable = typedArray.getDrawable(R.styleable.MovieDetailsExpandableTextView_expandDrawable);
        mCollapseDrawable = typedArray.getDrawable(R.styleable.MovieDetailsExpandableTextView_collapseDrawable);
        mClickType = typedArray.getInt(R.styleable.MovieDetailsExpandableTextView_clickListenerType, ClickAll);
