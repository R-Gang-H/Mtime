...
/**
 * create by lushan on 2022/4/11
 * des:
 **/
data class PostContent(
    var saveAction: Long? = null,//保存动作1：草稿 2：发布
    ...
    var recId: Long? = null, // 记录ID 必填 新增调用未发布内容-获取我的新记录ID的API获取，修改获取我的编辑内容API里有recId
    var contentId: Long? = null, // 内容ID 新记录不填,已发布之后再次保存必填
    var groupId: Long? = null, // 群组ID
    var sectionId: Long? = null, // sectionId
    ...
    @CommentPermission var commentPmsn: Long? = null, // 评论权限 ALLOW_ALL(1, "允许任何人"), FORBID_ALL(2, "禁止所有人");
