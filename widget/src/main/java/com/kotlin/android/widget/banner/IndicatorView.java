...
public class IndicatorView extends View implements Indicator {
    ...
    public IndicatorView setIndicatorColorRes(@ColorRes int indicatorColorRes) {
        this.unColor = getContext().getColor(indicatorColorRes);
        return this;
    }

    public IndicatorView setIndicatorSelectorColorRes(@ColorRes int indicatorSelectorColorRes) {
        this.selectedColor = getContext().getColor(indicatorSelectorColorRes);
        return this;
    }
