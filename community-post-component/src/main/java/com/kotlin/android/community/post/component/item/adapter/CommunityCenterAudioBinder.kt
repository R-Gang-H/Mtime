...
import com.kotlin.android.community.post.component.databinding.ItemCommunityCenterAudioBinding
 ...
 * @date 2022/3/27
 */
open class CommunityCenterAudioBinder(
    val post: CommunityPostItem
) : MultiTypeBinder<ItemCommunityCenterAudioBinding>() {

    private val mUgcProvider by lazy { getProvider(IUgcProvider::class.java) }
    private val mCommunityProvider by lazy { getProvider(ICommunityPersonProvider::class.java) }

    override fun layoutId(): Int = R.layout.item_community_center_audio

    override fun areContentsTheSame(other: MultiTypeBinder<*>): Boolean {
        return other is CommunityCenterAudioBinder && other.post.hashCode() == post.hashCode()
    }

    override fun onBindViewHolder(binding: ItemCommunityCenterAudioBinding, position: Int) {
