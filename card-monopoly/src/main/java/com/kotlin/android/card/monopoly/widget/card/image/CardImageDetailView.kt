 ...
 * @author o.s
 */
class CardImageDetailView : FrameLayout {
    ...
    private fun fillCardView() {
        card?.apply {
            imageView?.loadImage(
                ...
                defaultImg = getDrawable(R.drawable.ic_card_loading),
                errorImg = getDrawable(R.drawable.ic_def_card_fail),
            )
...
//                imageView?.setImageResource(R.mipmap.ic_card_placeholder_none)
                imageView?.loadImage(
                    data = R.mipmap.ic_card_placeholder_none,
                    defaultImgRes = R.mipmap.ic_card_placeholder_none,
                )
            }
