...
import com.kotlin.android.card.monopoly.widget.card.adapter.IssueSuitsAdapter
 ...
 * @author o.s
 */
class IssueSuitsView : RecyclerView {

    private val edge = 25.dp
    ...
    var edgeBottom = 0
        set(value) {
            field = value
            addItemDecoration(AverItemDecoration(spanCount, edge, edge, value))
        }

    private val mAdapter: IssueSuitsAdapter by lazy {
        IssueSuitsAdapter {
            action?.invoke(it)
        }
    }
    ...
    private fun initView() {
        ...
        addItemDecoration(AverItemDecoration(spanCount, edge, edge, edgeBottom))
