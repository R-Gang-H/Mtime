...
public class IRecyclerView extends RecyclerView {
    ...
    private int mLoadMorePreloadCount = 0;
    ...
    private OnIScrollListener mOnIScrollListener;

    private OnIRefreshListener mOnIRefreshListener;
            ...
            if (mOnLoadMoreScrollListener == null) {
                mOnLoadMoreScrollListener = new OnLoadMoreScrollListener() {
                    ...
                    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                        ...
                        if (mOnIScrollListener != null){
                            mOnIScrollListener.onScrolled(recyclerView, dx, dy);
                        }
                    }
    
                    @Override
                    public int getPreloadCount() {
                        return mLoadMorePreloadCount;
                    }
    
                    @Override
                    public void onLoadMore(RecyclerView recyclerView) {
                        if (!mLoadMoreLoading && mOnLoadMoreListener != null && mStatus == STATUS_DEFAULT) {
...
//            addOnScrollListener(mOnLoadMoreScrollListener);
            setOnScrollListener(mOnLoadMoreScrollListener);
        } else {
            if (mOnLoadMoreScrollListener != null) {
//                removeOnScrollListener(mOnLoadMoreScrollListener);
            }
    ...
    public void setLoadMorePreloadCount(int loadMorePreloadCount) {
        mLoadMorePreloadCount = loadMorePreloadCount;
    }
    
    public void setLoadMoreLoading(boolean loadMoreLoading) {
        mLoadMoreLoading = loadMoreLoading;
    }
    ...
    public void setOnIScrollListener(OnIScrollListener listener) {
        this.mOnIScrollListener = listener;
    }

    public void setOnIRefreshListener(OnIRefreshListener listener) {
        this.mOnIRefreshListener = listener;
    }
    ...
    public void setRefreshing(boolean refreshing) {
        if (mStatus == STATUS_DEFAULT && refreshing) {
            ...
            this.mIsAutoRefreshing = false;
            LogWriter.e(TAG, "isRefresh = " + refreshing + " current status = " + mStatus);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (index < 0) {
                    LogWriter.e(TAG, "Error processing scroll; pointer index for id " + index + " not found. Did any MotionEvents get skipped?");
                    return false;
                }
                ...
                if (DEBUG) {
                    LogWriter.i(TAG, "triggerCondition = " + triggerCondition + "; mStatus = " + mStatus + "; dy = " + dy);
                }
                if (triggerCondition) {
    ...
    Animator.AnimatorListener mAnimationListener = new SimpleAnimatorListener() {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (DEBUG) {
                LogWriter.i(TAG, "onAnimationEnd " + getStatusLog(lastStatus) + " -> " + getStatusLog(mStatus) + " ;refresh view height:" + mRefreshHeaderContainer.getMeasuredHeight());
            }
        }
    };
    ...
    RefreshTrigger mRefreshTrigger = new RefreshTrigger() {
        ...
        public void onStart(boolean automatic, int headerHeight, int finalHeight) {
            ...
            if (mOnIRefreshListener != null){
                mOnIRefreshListener.onRefreshStart();
            }
        }
    ...
    private void printStatusLog() {
        LogWriter.i(TAG, getStatusLog(mStatus));
    }
    ...
    private final List<ItemDecoration> itemDecorationList = new ArrayList<>();
    private IItemDecoration iItemDecoration;
    @Override
    public void addItemDecoration(ItemDecoration decor) {
        itemDecorationList.add(decor);
        if(null == iItemDecoration) {
            iItemDecoration = new IItemDecoration();
            super.addItemDecoration(iItemDecoration);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        iItemDecoration = null;
    }

    class IItemDecoration extends ItemDecoration {
        /**
        ...
        public void onDraw(Canvas c, RecyclerView parent, State state) {
            for(ItemDecoration i : itemDecorationList) {
                i.onDraw(c, parent, state);
            }
        }
        ...
        public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
            if(itemPosition > 1) {
                for (ItemDecoration i : itemDecorationList) {
                    i.getItemOffsets(outRect, itemPosition - 2, parent);
                }
            }
        }
        ...
        public void getItemOffsets(Rect outRect, View view, RecyclerView parent, State state) {
            ...
            if(position > 1) {
                for (ItemDecoration i : itemDecorationList) {
                    i.getItemOffsets(outRect, view, parent, state);
                }
            }
        }
    }
