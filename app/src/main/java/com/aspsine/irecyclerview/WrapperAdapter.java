...
public class WrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final int FOOTER = Integer.MAX_VALUE - 1;
...
//        }
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    ...
                    } else if (null != oldSizeLookup) {
                        return oldSizeLookup.getSpanSize(position -2);
                    }
                    return 1;
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        } else if (null != mAdapter && !isMyHolder(holder)) {
    ...
    public void onViewDetachedFromWindow(RecyclerView.ViewHolder holder) {
        ...
        int position = holder.getLayoutPosition();
        int type = getItemViewType(position);
        if (null != mAdapter && !isMyHolder(holder) && !isFullSpanType(type)) {
    ...
    private boolean isMyHolder(RecyclerView.ViewHolder holder) {
        return holder instanceof RefreshHeaderContainerViewHolder || holder instanceof HeaderContainerViewHolder
                || holder instanceof FooterContainerViewHolder || holder instanceof LoadMoreFooterContainerViewHolder;
    }
