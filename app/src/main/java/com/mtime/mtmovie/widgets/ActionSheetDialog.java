...
/**
 * 通用仿ios底部滑出菜单
 * Created by YinGuanPing on 2016/10/13.
 */
public class ActionSheetDialog {
    ...
    public ActionSheetDialog builder(final OnSheetCancleClickListener onSheetCancleClickListener) {
        isShowing = true;
        // 获取Dialog布局
        View view = LayoutInflater.from(context).inflate(R.layout.view_actionsheet, null);
        ...
        txt_cancel.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                onSheetCancleClickListener.onCancle();
                dialog.dismiss();
                isShowing = false;
            }
        });
    ...
    public ActionSheetDialog addSheetItem(String[] strItem, OnSheetItemClickListener listener) {
        ...
        for (int i = 0; i < strItem.length; i++) {
            sheetItemList.add(new SheetItem(strItem[i], null, listener));
        }
        return this;
    }
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            textView.setBackgroundResource(R.drawable.actionsheet_content_selector);
            ...
            // 高度
            int height = context.getResources().getDimensionPixelSize(R.dimen.offset_50dp);
    ...
    public interface OnSheetCancleClickListener {
        void onCancle();
    }
