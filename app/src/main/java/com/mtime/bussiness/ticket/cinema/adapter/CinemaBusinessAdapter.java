...
//
//public class CinemaBusinessAdapter extends BaseAdapter {
//
//    private final BaseActivity           context;
//    private final List<BusinessAreaBean> stationBaseBeans;
//    private CinemaFilterAdapterListener listener;
//    private int                          selected;
//
//    public CinemaBusinessAdapter(final BaseActivity context, final List<BusinessAreaBean> stationBaseBeans) {
...
//                    notifyDataSetChanged();
//                    if (null != listener) {
//                        listener.onEvent(CinemaFilterAdapterType.TYPE_BUSINESS, selected);
//                    }
//                }
//            });
//        }
