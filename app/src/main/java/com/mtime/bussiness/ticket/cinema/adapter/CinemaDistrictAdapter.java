...
//
//public class CinemaDistrictAdapter extends BaseAdapter {
//
//    private final BaseActivity           context;
//    private final List<DistrictBaseBean> districtBaseBeans;
//    private CinemaFilterAdapterListener listener;
//    private int                          selected;
//
//    public CinemaDistrictAdapter(final BaseActivity context, final List<DistrictBaseBean> subwayBaseBeans) {
//        this.context = context;
//        districtBaseBeans = subwayBaseBeans;
//        selected = -1;
//    }
//
...
//
//    public int getCount() {
//        return districtBaseBeans.size() + 1;
//    }
//
...
//                    notifyDataSetChanged();
//                    if (null != listener) {
//                        listener.onEvent(CinemaFilterAdapterType.TYPE_DISTRICT, selected);
//                    }
//                }
//            });
//        }
...
//        }
//        else {
//            holder.trainName.setText(districtBaseBeans.get(arg0 - 1).getName());
