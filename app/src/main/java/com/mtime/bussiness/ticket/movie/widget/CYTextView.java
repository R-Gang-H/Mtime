...
public class CYTextView extends TextView {
     ...
     * 缓存测量过的数据
     */
    private static final HashMap<String, SoftReference<MeasuredData>> measuredData = new HashMap<String, SoftReference<MeasuredData>>();
     ...
     */
    private final ArrayList<Object> obList = new ArrayList<Object>();
    /**
     ...
     */
    private final Paint textBgColorPaint = new Paint();
    /**
     * {@link android.text.style.BackgroundColorSpan}用
     */
    private final Rect textBgColorRect = new Rect();
