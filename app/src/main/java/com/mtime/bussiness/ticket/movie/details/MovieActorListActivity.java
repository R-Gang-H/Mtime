...
import com.mtime.bussiness.ticket.movie.details.holder.MovieActorListHolder;
 ...
 * @desc 影片演职员页
 */
public class MovieActorListActivity extends BaseFrameUIActivity<MovieStarsTotalBean, MovieActorListHolder> {
    ...
    public ContentHolder onBindContentHolder() {
        return new MovieActorListHolder(this);
    }
    ...
    protected void onInit(Bundle savedInstanceState) {
        ...
        // 埋点
        mBaseStatisticHelper.setPageLabel("screenCreditList");
    ...
    private void requestData() {
        mApi.getFullCredits(mMovieId, new NetworkManager.NetworkListener<MovieStarsTotalBean>() {
            @Override
            public void onSuccess(MovieStarsTotalBean result, String showMsg) {
            ...
            @Override
            public void onFailure(NetworkException<MovieStarsTotalBean> exception, String showMsg) {
    ...
    public static void launch(Context context, String refer, String movieId) {
        Intent launcher = new Intent(context, MovieActorListActivity.class);
