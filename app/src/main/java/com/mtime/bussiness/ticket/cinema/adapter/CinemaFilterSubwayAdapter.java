...
public class CinemaFilterSubwayAdapter extends RecyclerView.Adapter<CinemaFilterSubwayAdapter.ViewHolder> {
    ...
    public CinemaFilterSubwayAdapter(final Context context, final List<SubwayBean> list) {
    ...
    public void setList(final List<SubwayBean> list) {
        this.mList = list;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        SubwayBean bean = mList.get(position);
        ...
        if (mListener != null) {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mListener.onEvent(CinemaFilterAdapterType.TYPE_SUBWAY, holder.getIAdapterPosition());
                }
            });
        }
    }
