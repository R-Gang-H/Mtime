 ...
 * 
 */
public class ActorFilmographyAdapter extends RecyclerView.Adapter<ActorFilmographyAdapter.ViewHolder> {
    ...
    public ActorFilmographyAdapter(final BaseActivity context, final List<FilmographyBean> filmOgraphys) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.name.setText(String.format("%s(%s)", filmography.getName(), filmography.getYear()));
