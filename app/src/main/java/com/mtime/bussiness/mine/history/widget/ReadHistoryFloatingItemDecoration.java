...
public class ReadHistoryFloatingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public ReadHistoryFloatingItemDecoration(Context context) {
        init(context);
    }
     ...
     */
    public ReadHistoryFloatingItemDecoration(Context context, @DrawableRes int drawableId) {
     ...
     */
    public ReadHistoryFloatingItemDecoration(Context context, @ColorInt int color, @Dimension float dividerWidth, @Dimension float dividerHeight) {
