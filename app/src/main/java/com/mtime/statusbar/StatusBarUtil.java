...
public class StatusBarUtil {
     ...
     */
    @TargetApi(19)
    public static void setTranslucentStatus(Activity activity, boolean fitSystemWindows) {
        setRootViewFitsSystemWindows(activity, fitSystemWindows);
        setTranslucentStatus(activity);
    }
    ...
    public static boolean setStatusBarDarkTheme(Activity activity, boolean dark) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                setOPPOStatusTextColor(dark, activity);
            } else {//其他情况
                return false;
            }
    ...
    /**
     * copy from https://blog.csdn.net/qq_36230279/article/details/80664863
     */
    @TargetApi(21)
